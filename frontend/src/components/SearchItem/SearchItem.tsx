...
import { Button, Collapse, Drawer, Flex, Image, List, Modal, Space, Spin, Tag, theme, Tooltip, Typography } from 'antd';
...
const DesktopRecommendations: React.FC<RecommendationsProps> = ({ visible, onClose, recommendations, isLoading }) => {
  return (
    <Modal
          ...
          renderItem={(rec: any) => (
            <List.Item
              ...
              <List.Item.Meta
                ...
                title={<a href={rec.media.siteUrl}>{rec.media.title.english || rec.media.title.romaji}</a>}
                description={
...
const MobileRecommendations: React.FC<RecommendationsProps> = ({ visible, onClose, recommendations, isLoading }) => {
